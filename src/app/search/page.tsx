  ...
  const content = (() => {
    ...
    return (
      ...
      <>
        ...
        <section className="max-w-xl mx-auto mt-4 px-2 flex flex-row justify-between items-center">
        ...
        <section className="max-w-xl mx-auto flex flex-col sm:gap-2 mt-4 sm:mb-4">
